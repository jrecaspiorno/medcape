...
{Estructura habitual de la señal ECG durante un ciclo cardíaco \citep{onda}}
...
El corazón está constituido por cuatro cámaras diferenciadas: dos aurículas (izquierda y derecha) y dos ventrículos (izquierdo y derecho) como puede apreciarse en la [Fig \ref{fig:corazon}] \footnote{Fuente original: \href{http://respuestas.tips/cuales-son-las-partes-que-componen-el-corazon-humano/}{http://respuestas.tips/cuales-son-las-partes-que-componen-el-corazon-humano/}}.
...
El equipo de registro consta de una serie de electrodos, que se conectan a la piel del paciente y a un equipo de registro. Estos electrodos se colocan en unas posiciones predeterminadas y universales, lo que permite obtener el registro del sistema de la forma más precisa y exacta posible. En la [Fig \ref{fig:electrodos}] \footnote{Fuente original: \href{https://es.pinterest.com/bvs2425709/nursing/}{https://es.pinterest.com/bvs2425709/nursing/}} se ilustran los puntos más importantes a tener en cuenta, a la hora de colocar los electrodos.
...
{Estándar de comunicación SPI \citep{spi}}
...
\begin{itemize}
  \item \textbf{Frecuencia máxima de transferencia}: La velocidad de comunicación  con cada dispositivo estará limitada por este valor, haciendo imposible enviar o recibir datos a mayor velocidad.
   \item \textbf{Polaridad} (CPOL): Determina la polaridad del reloj [Fig \ref{fig:spi3}] \footnote{Fuente original: \href{https://electricimp.com/docs/resources/spi/}{https://electricimp.com/docs/resources/spi/}}.
...
{Diagrama de funcionamiento interno ADS1198 \citep{ads1198}}
...
Durante gran parte del desarrollo del proyecto se ha recurrido a un simulador de pacientes similar al que puede apreciarse en la [Fig \ref{fig:sim}] \footnote{Fuente original: \href{http://www.medicalexpo.com/prod/he-instruments/product-112471-745933.html}{http://www.medicalexpo.com/prod/he-instruments/product-112471-745933.html}}.
...
Para la medición de la frecuencia cardíaca se han utilizado dos formas de medición distintas. En primer lugar un POLAR Soft strap como el que puede verse en la [Fig \ref{fig:cinturon}]  \footnote{Fuente original: \href{https://bike-dump.nl/Shop/Artikel/2030/Polar-Soft-Strap}{https://bike-dump.nl/Shop/Artikel/2030/Polar-Soft-Strap}}, que permite una medición confortable gracias al acabado elástico que ofrece el producto. Por otra parte se han utilzado electrodos de botón pregelizado como los que pueden observarse en la [Fig \ref{fig:pegatinas}] \footnote{Fuente original: \href{http://hospiinnova.com/49-ecg}{http://hospiinnova.com/49-ecg}}. Las pegatinas han aportado un mejor resultado debido a la mayor ausencia de ruido que presenta la captación final de la señal.
