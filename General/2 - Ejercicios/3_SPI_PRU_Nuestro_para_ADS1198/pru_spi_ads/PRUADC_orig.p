...
//Set output pins to 0 (just in case):
 ...
 // Enable the OCP master port -- allows transfer of data to Linux userspace
	...
	LBBO	r11, r1, 24, 28	 // load the size that is passed into r9 -- the number of samples to take
...
DELAY_1:
	...
	QBNE	DELAY_1, r12, 0  // repeat loop unless zero
//----------------------ADS_SAMPLE_RATE----------------------
...
SEND_SAMPLE_RATE_2: //WRITE REGISTERS
	LBBO	r2, r1, 8, 12	 // Load config3 register
	CLR	r30.t5		 // set the CS line low (active low)
	MOV	r4, 8		 // going to write/read 24 bits (3 bytes)
...
DELAY_2:
	SUB	r12, r12, 1     // decrement loop counter
	QBNE	DELAY_2, r12, 0  // repeat loop unless zero
...
SPICLK4_BIT:                      // loop for each of the 8 bits 
	...
	SET	r30.t5		 // pull the CS line high (end of sample)
		...
		//----------------------------------
SEND_SAMPLE_RATE_3: //WRITE REGISTERS
...
DELAY_3:
	SUB	r12, r12, 1     // decrement loop counter
	QBNE	DELAY_3, r12, 0  // repeat loop unless zero
//------------------START--------------------------
		SET 	r30.t7 //Start
//---------------------RDATAC----------------------
SEND_RDATAC:
